...
if(isset($_POST['Customers_Order']))
{
        ...
        $db = new DbContext();
        $Orders = $db->Customers_Order($request);
        //  $Orders = $db->View_All_Orders();

        $OrderHead .= "  <div class=\"w3-container\">
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="contact" style="margin-top:75px">
        ...
        <form <?php echo $_SERVER['PHP_SELF']; ?>>
            ...
            <button name = "Customers_Order" type="submit" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">Confirm</button>
        </form>
    </div>
